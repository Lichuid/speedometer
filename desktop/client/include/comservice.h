...
class COMService
{
    ...
    /**
     * @brief Read buffer as little-endian 24-bit integer

     *
     * @param buffer The comservice buffer
     * @return The contents of the buffer as a uint32_t value
     */
    uint32_t bufferToValue(const uint8_t *buffer);
